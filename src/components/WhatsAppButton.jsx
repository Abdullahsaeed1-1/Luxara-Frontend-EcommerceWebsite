...
const WhatsAppButton = () => {
  ...
  const handleClick = () => {
    const message = encodeURIComponent("Hi Luxara! I'm interested in placing an order. 🛍️");
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex items-center gap-3">
      ...
      <button
        ...
        className="relative w-14 h-14 rounded-full shadow-xl flex items-center justify-center hover:scale-110 transition-transform duration-300 active:scale-95"
